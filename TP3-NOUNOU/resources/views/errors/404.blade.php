    ...
    <main id="404">
        <div class="flex min-h-screen items-center justify-center p-6">
            <div class="text-center mr-10">
                ...
                <p class="mt-4 text-2xl font-semibold text-gray-700">Oups ! Cette page est introuvable.</p>
                <p class="mt-2 text-gray-500">Il semble que la page que vous recherchez n'existe pas.</p>
                <a href="{{ url('/') }}"
            ...
            <svg fill="#DDF1CF" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60" xml:space="preserve" width="200px"
                height="200px" stroke="#DDF1CF" stroke-width="0.0006000000000000001" class="ml-10">
