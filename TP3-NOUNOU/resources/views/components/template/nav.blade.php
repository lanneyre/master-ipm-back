            ...
            <a href="#user" class="modaleUser icon" modale="user-{{ Auth::getUser()->id }}">
                <svg width="30px" height="30px" viewBox="-6.24 -6.24 36.48 36.48" fill="none"
                    ...
                    <g id="SVGRepo_bgCarrier" stroke-width="0">
                        <rect x="-6.24" y="-6.24" width="36.48" height="36.48" rx="18.24" fill="#DDF1CF"
                            strokewidth="0"></rect>
                    </g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <circle cx="9" cy="9" r="2" stroke="#1C7C54" stroke-width="1.44"></circle>
                        <path
                            d="M13 15C13 16.1046 13 17 9 17C5 17 5 16.1046 5 15C5 13.8954 6.79086 13 9 13C11.2091 13 13 13.8954 13 15Z"
                            stroke="#1C7C54" stroke-width="1.44"></path>
                        <path
                            ...
                            stroke="#1C7C54" stroke-width="1.44" stroke-linecap="round"></path>
                        <path d="M19 12H15" stroke="#1C7C54" stroke-width="1.44" stroke-linecap="round"></path>
                        <path d="M19 9H14" stroke="#1C7C54" stroke-width="1.44" stroke-linecap="round"></path>
                        <path d="M19 15H16" stroke="#1C7C54" stroke-width="1.44" stroke-linecap="round"></path>
                    </g>
                </svg>
            </a>
                ...
                <svg width="30px" height="30px" viewBox="-6.24 -6.24 36.48 36.48" fill="none"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <path opacity="0.5"
                            ...
                            stroke="#1C7C54" stroke-width="1.44"></path>
                        <path d="M15 12L6 12M6 12L8 14M6 12L8 10" stroke="#1C7C54" stroke-width="1.44"
                ...
                <svg width="30px" height="30px" viewBox="-6.24 -6.24 36.48 36.48" fill="none"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <path opacity="0.5"
                            d="M8 19.5C5.64298 19.5 4.46447 19.5 3.73223 18.7678C3 18.0355 3 16.857 3 14.5V9.5C3 7.14298 3 5.96447 3.73223 5.23223C4.46447 4.5 5.64298 4.5 8 4.5"
                            stroke="#1C7C54" stroke-width="1.44"></path>
                        <path d="M6 12L15 12M15 12L12.5 14.5M15 12L12.5 9.5" stroke="#1C7C54" stroke-width="1.44"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                    </g>
                </svg>
            </a>
