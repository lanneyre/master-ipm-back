...
<body>
    ...
    <main>
        ...
        @endif
        @auth
            @if (in_array(Auth::getUser()->role, [1, 3]))
                <a href="#admin" id="admin" class="modaleAdmin icon" modale="admin-menu">
                    <svg fill="#1C7C54" viewBox="-499.2 -499.2 2918.40 2918.40" xmlns="http://www.w3.org/2000/svg"
                        stroke="#1C7C54" stroke-width="0.019200000000000002">
                        <g id="SVGRepo_bgCarrier" stroke-width="0">
                            <rect x="-499.2" y="-499.2" width="2918.40" height="2918.40" rx="1459.2" fill="#DDF1CF"
                                strokewidth="0"></rect>
                        </g>
                ...
                @include('components.template.menuAdmin', ['titre' => 'Administration'])
            @endif
        @endauth
